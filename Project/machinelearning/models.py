...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        r1 = nn.ReLU(nn.AddBias(xw1, self.b1))
        xw2 = nn.Linear(r1, self.w2)
        r2 = nn.ReLU(nn.AddBias(xw2, self.b2))
        xw3 = nn.Linear(r2, self.w3)
        return nn.AddBias(xw3, self.b3)
    ...
    def train(self, dataset):
        ...
        while True:
            for x, y in dataset.iterate_once(self.batch_size):
                ...
                self.wh.update(grad[1], self.learning_rate)
                self.wf.update(grad[2], self.learning_rate)
